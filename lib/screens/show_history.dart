                          ...
                          itemBuilder: (context, index) {
                            ...
                            iscomplete() {
                              if (currentTask.isCompleted == true) {
                                return " Görev Tamamlama Saati : ${currentTask.completedTime}  \n  ${currentTask.date}";
                              } else {
                                return "${currentTask.starttime} - ${currentTask.endtime} üzerinde atanmış ${currentTask.date}";
                              }
                            }
                            ...
                            child: Center(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  const Text(
                                    " Üretkenliğinizi Artırmak İçin Bazı Görevler Ekleyin!",
                                    style: TextStyle(
                                        color: Colors.white,
                                        fontSize: 15,
                                        fontStyle: FontStyle.normal,
